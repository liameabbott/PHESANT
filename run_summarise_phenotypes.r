...
for (i in seq(1, 4)) {
    ...
    log_file_both <- paste0('../ukb31063.phesant.both_sexes.', i, '.log')
    log_file_females <- paste0('../ukb31063.phesant.female.', i, '.log')
    log_file_males <- paste0('../ukb31063.phesant.male.', i, '.log')
